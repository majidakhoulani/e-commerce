              ...
              <v-row no-gutters>
                  ...
                  <v-col  v-for="team in teamList" :key="team.id" cols="12" sm="4"
                      ...
                      <div>
                          ...
                          <v-img :src="`/team/${team.src}.jpg`" height="200px" width="200px" cover class="rounded-circle"
                            style="border:8px solid rgb(193 193 193 / 66%);"></v-img>
                          <!-- <v-img v-for="image in photos" :src="image" height="200px" width="200px" cover class="rounded-circle"
                            style="border:8px solid rgb(193 193 193 / 66%);"></v-img> -->
